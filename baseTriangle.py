...
def appartenance_Triangle(L_Triangle, P):
    ...
    for (a,b,c) in L_Permutations:
        if ((L_Triangle[a][1]-L_Triangle[b][1])*L_Triangle[c][0]+(L_Triangle[b][0]-L_Triangle[a][0])*L_Triangle[c][1]+(L_Triangle[a][0]*L_Triangle[b][1]-L_Triangle[b][0]*L_Triangle[a][1]))*((L_Triangle[a][1]-L_Triangle[b][1])*P[0]+(L_Triangle[b][0]-L_Triangle[a][0])*P[1]+(L_Triangle[a][0]*L_Triangle[b][1]-L_Triangle[b][0]*L_Triangle[a][1]))<0:
...
def base_Triangle(nb_points,xmax,ymax):
    ...
    LL_Triangles=[]
    (x,y)=(randint(1,xmax-1),randint(1,ymax-1))
    ...
    for i in range(nb_points-1):
        ...
        for L_Triangle in LL_Triangles:
            ...
            if appartenance_Triangle(L_Triangle,(x,y)):
